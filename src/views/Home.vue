        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda la seguridad en software, centrada en cifrado, autenticación y certificados digitales. Se estudian algoritmos de cifrado simétrico (AES, DES) y asimétrico (RSA, ECC), gestión de claves, y herramientas como VeraCrypt y GPG. Se analizan protocolos de autenticación como OAuth, SAML y OpenID Connect, destacando su implementación y buenas prácticas. Además, se profundiza en certificados digitales, su ciclo de vida y aplicaciones. Se promueve el aprendizaje práctico con ejemplos reales, fortaleciendo habilidades para desarrollar soluciones seguras en sistemas modernos.
